...
sudo docker exec -it host1 /bin/bash ifconfig eth1 192.168.1.2/24 mtu 1400
sudo docker exec -it host1 /bin/bash ip route replace default via 192.168.1.1
sudo docker exec -it host2 /bin/bash ifconfig eth1 192.168.2.2/24 mtu 1400
sudo docker exec -it host2 /bin/bash ip route replace default via 192.168.2.1
